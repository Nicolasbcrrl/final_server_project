...
import com.serrverprogramming.project.server_project.domain.SignupForm;
...
public class UserController {
    ...
    //method to save the user into the database and to check if the user already exists and if the passwords match and encrypt the password
